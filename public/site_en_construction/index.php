...
<head>
	...
	<link rel="shortcut icon" href="./fichiers/favicon.png">
...
<body>
	<div id="cspio-page">
		<div id="cspio-content">
			...
			<img id="cspio-logo" src="./fichiers/logo.png">
			    				
			<h1 id="cspio-headline">Site en construction</h1>			    				
			
			<div id="cspio-description">Sois prêt! Quelque chose de vraiment cool arrive !</div>			    				
			
			<form id="cspio-form" action="index.php" method="post">
				<div id="cspio-field-wrapper">
					<div class="row">
						<div class="col-md-12 seperate"><div class="input-group"><input id="cspio-email" name="email" class="form-control input-lg form-el" type="email" placeholder="Email" required/>
							...
							<div class="form-group"><input class="form-control" data-label="Subject" data-msg="Svp entrez le sujet de votre message." name="subject" placeholder="Entrez le sujet" required="" type="hidden" /></div><span class="input-group-btn"><button id="cspio-subscribe-btn" type="submit" class="btn btn-lg btn-primary form-el noglow">Informez-moi</button></span></div></div>
					</div>
				</div>
			</form>
			
			<span id="cspio-privacy-policy-txt">Nous nous engageons à ne jamais vous spammer.</span>
	...
	if($email_address != "") {
		...
		echo "Votre email a bien été envoyé, merci. A très vite.";
	}
