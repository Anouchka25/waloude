 ...
 */
final class Version20200430150725 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE souscripteur ADD nombre_beneficiaires VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE souscripteur DROP nombre_beneficiaires');
